...
class Controller extends EventEmitter {
  ...
  someMethod() {
    console.log('call someMethod(Controller) complete');
  }
  someMethod2() {
    console.log('call someMethod2(Controller) complete');
  }
  ...
  //   model.$configCurrentValueElem = thisForController.next().find('.configuration__current-value_first');
  //   model.$configCurrentValueRangeElem = thisForController.next().find('.configuration__current-value_second');
  ...
  //   model.$configSizeOfStepElem = thisForController.next().find('.configuration__size-of-step');
    ...
    // if (model.rangeStatus) {odel.$sliderElem.click((event) => {
